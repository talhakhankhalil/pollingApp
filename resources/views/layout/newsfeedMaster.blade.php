            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        <li class="active">
                            <a href="{{route('poll.index')}}"><i class="fa fa-fw fa-dashboard"></i> Polls</a>
                        </li>
                        <li>
                            <a href="{{route('poll.create')}}"><i class="fa fa-fw fa-bar-chart-o"></i> Create Poll</a>
                        </li>
                        <li>
                            <a href="{{route('newsfeed.create')}}"><i class="fa fa-fw fa-table"></i>Create News Feed</a>
                        </li>
                        <li>
